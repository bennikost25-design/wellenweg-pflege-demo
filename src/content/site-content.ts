...
export const contactPage = {
  ...
  pathways: [
    ...
    {
      id: "vorort",
      title: "Persönlichen Termin abstimmen",
      text: "Gerne lernen wir uns persönlich kennen. Einen Termin stimmen wir telefonisch ab – es gibt kein Online-Buchungssystem.",
