...
export function ContactClose() {
  return (
    <section
      className="relative overflow-hidden bg-brand py-16 text-white"
      aria-labelledby="contact-close-heading"
    >
      <div className="pointer-events-none absolute inset-0" aria-hidden="true">
        <svg
          className="absolute -right-10 top-0 h-full w-[55%] opacity-25"
          viewBox="0 0 400 400"
          fill="none"
        >
          <path
          ...
          <div className="max-w-3xl">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
              ...
              <a
                ...
                className="inline-flex min-h-11 items-center justify-center gap-2 rounded-xl border-2 border-white/70 bg-transparent px-5 py-2.5 text-base font-semibold text-white hover:bg-white/10"
              >
